# save agriculture - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **save agriculture**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@saveagriculture.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@saveagriculture.cm` | `user123` | |
...
*   **Contact :** contact@saveagriculture.cm